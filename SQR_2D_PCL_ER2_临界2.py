...
r = 0#重复计数
r_max = 5#重复限值
t_max = int(0.951*n*n)#最大连接数
k = int(n*n/1000)#测量间隔
t_max_k = int(t_max/k)
tb = int(0.88*n*n)#起始记录位置
te = int(0.95*n*n)#终止记录位置
data_c_avr=[]
rt_up = []
rt_down = []
data_c_max = []
...
data=open("D:/个人文件/大学/大二下/课程/热力学与统计物理/课程论文/QU算法模拟渗流/data_SQER2_200(临界现象).txt",'w+')
print ("---File open---") 
print ("Iterating...")

pcl = SQR_2D_PCL_RB2.sqr_2D_pcl(n)
