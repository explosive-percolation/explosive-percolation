# -*- coding: utf-8 -*-
"""
Created on Wed May 29 09:34:53 2019
...
t_max_k = int(t_max/k)
tb = int(0.7*n*n*n)#起始记录位置
te = int(0.8*n*n*n)#终止记录位置
data_c_avr=[]
rt_up = []
rt_down = []
data_c_max = []
...
data=open("D:/个人文件/大学/大二下/课程/热力学与统计物理/课程论文/QU算法模拟渗流/3d方格子/data_CUER_50(临界现象).txt",'w+')
print ("---File open---") 
print ("Iterating...")
